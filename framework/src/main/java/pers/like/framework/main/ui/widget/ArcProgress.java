...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = dipToPx(18);
        min_size = dipToPx(100);
        default_text_size = dipToPx(40);
        default_suffix_text_size = dipToPx(15);
        default_suffix_padding = dipToPx(4);
        default_suffix_text = "%";
        default_bottom_text_size = dipToPx(10);
        default_stroke_width = dipToPx(4);
    ...
    private int dipToPx(int dip) {
        return (int) (getContext().getResources().getDisplayMetrics().densityDpi / 160 * dip + 0.5f);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            float suffixWidth = textPaint.measureText(text);
            textPaint.setTextSize(suffixTextSize);
            float suffixHeight = textPaint.descent() + textPaint.ascent();
            canvas.drawText(suffixText, getWidth() / 2.0f + suffixWidth / 2.0f + suffixTextPadding, textBaseline + textHeight - suffixHeight, textPaint);
        }
