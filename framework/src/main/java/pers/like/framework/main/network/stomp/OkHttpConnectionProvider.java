        ...
        openSocket = mOkHttpClient.newWebSocket(requestBuilder.build(),
                new WebSocketListener() {
                    ...
                    public void onFailure(WebSocket webSocket, Throwable t, Response response) {
                        ...
                        emitLifecycleEvent(new LifecycleEvent(LifecycleEvent.Type.ERROR, new Exception(t), -1));
                        openSocket = null;
                        emitLifecycleEvent(new LifecycleEvent(LifecycleEvent.Type.CLOSED, JsonUtils.toJson(t), -1));
                    }
