...
public class Stomp {
    ...
    public static StompClient over(@NonNull Provider connectionProvider, String uri) {
     ...
     */
    public static StompClient over(@NonNull Provider connectionProvider, String uri, Map<String, String> connectHttpHeaders) {
     ...
     * @return StompClient for receiving and sending messages. Call #StompClient.connect
     */
    public static StompClient over(@NonNull Provider connectionProvider, String uri, @Nullable Map<String, String> connectHttpHeaders, @Nullable OkHttpClient okHttpClient) {
        if (connectionProvider == Provider.JWS) {
        ...
        if (connectionProvider == Provider.OK_HTTP) {
